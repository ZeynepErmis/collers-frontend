        ...
        <section className="section-3 text-white py-5">
            <div className="container">
                ...
                <div className="d-flex justify-content-between align-items-center mb-5">
                    ...
                    <Button className="custom-signupnow-btn">Sign up now</Button>
                </div>
                ...
                <div className="box-section">
                    <div className="row row-background">
                        ...
                        <div className="col-md-4 mb-4">
                            <div className="box-container rounded-3 overflow-hidden"> {/* rounded-3: Yuvarlak köşeler, overflow-hidden: köşe taşıma */}
                                <img src={SneakerSC31} alt="Product 1" className="img-fluid img-custom" /> {/* img-custom sınıfı ile sıfır boşluk */}
                                <div className="p-3">
                                    <h5 className="mb-2">Product Title 1</h5>
